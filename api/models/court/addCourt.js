...
const addCourt = async (req, res) => {
  ...
  try {
    ...
    const courtQuery = `
      INSERT INTO courts (user_id, court_name, court_type, venue_overview, rules_of_venue)
      VALUES ($1, $2, $3, $4, $5)
      RETURNING id;
    `;
    const courtValues = [
    ...
    const locationQuery = `
      INSERT INTO locations (country, city, location_link, court_id)
      VALUES ($1, $2, $3, $4)
      RETURNING id;
    `;
    ...
    const venuePriceQuery = `
      INSERT INTO venue_price (court_id, starting_price, max_guests, additional_guests, price_of_additional_guests)
      VALUES ($1, $2, $3, $4, $5);
    `;
